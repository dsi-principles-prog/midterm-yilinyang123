...
output: 1(age under or equal 40); 0(age above 40)
...
output: 1(with booking record); 0(without booking record)
...
The date first booking on which day of week will also affect the travel destination. Let's set a function that given date first booking, returns the day of the week of the date.

input: date_first_booking

output: the day of the week of the date
